...
// Keywords that trigger showing the WhatsApp CTA — covers pricing, uncertainty, ordering, and common "I don't know" phrasings
const WA_TRIGGER_PATTERNS = /price|cost|order|buy|purchase|delivery|ship|quote|minimum|moq|stock|availab|don't know|not sure|contact|unable|can't confirm|cannot confirm|please contact|reach out|get in touch|whatsapp|team/i;
